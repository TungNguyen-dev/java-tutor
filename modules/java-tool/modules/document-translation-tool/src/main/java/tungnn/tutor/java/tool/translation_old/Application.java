package tungnn.tutor.java.tool.translation_old;

import java.nio.file.Path;
import java.util.concurrent.Executors;
import tungnn.tutor.java.tool.translation_old.config.AppConfig;
...
import tungnn.tutor.java.tool.translation_old.core.text.DummyTextTranslator;
import tungnn.tutor.java.tool.translation_old.core.text.orchestrator.DefaultTextTranslatorOrchestrator;
import tungnn.tutor.java.tool.translation_old.service.impl.SimpleTranslationService;
